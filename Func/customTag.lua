...
-- GET HEX from RBG Color
local function GetHexColor(color)
	color.r = color.r <= 1 and color.r >= 0 and color.r or 1
	color.g = color.g <= 1 and color.g >= 0 and color.g or 1
	color.b = color.b <= 1 and color.b >= 0 and color.b or 1
...
oUF.Tags.Events["unit:shorthealth"] = "UNIT_HEALTH"
